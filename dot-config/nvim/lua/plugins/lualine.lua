...
local function config()
  require('lualine').setup {
    ...
    sections = {
      ...
      lualine_x = {
        -- Each sync state uses a distinct glyph (check/refresh/pause/error), so
        -- the icon is legible without state coloring; let it inherit the
        -- section's default fg/bg rather than a Diagnostic highlight group.
        obsidian_sync,
        'encoding',
        'fileformat',
        'filetype',
